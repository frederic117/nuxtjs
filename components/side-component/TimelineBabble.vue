    ...
    <div>
      <nav class="navbar is-dark subMenu">
        <div class="babblesMenu">
          ...
          <span v-if="filterBy === 'songs'" class="babMenu">
            <img
              loading="lazy"
              class="is-30 invertOk"
              ...
              alt="chant"
            />
            {{ langSelected === "EN" ? "our songs" : "nos chants" }}
            <nuxt-link
              v-if="$auth.user && $auth.user._id"
              :to="`/chant/team/${team.shortName}/${team._id}/`"
            >
              <img
                loading="lazy"
                class="is-20"
          ...
          <span v-if="filterBy === 'buts'" class="babMenu">
            <img
              loading="lazy"
              class="is-30"
      ...
      <div v-if="filterBy != 'forum' && babblesTodisplay" class>
        <div class="babble-container">
          <div
            class="babbles-box"
            v-if="babblesTodisplay.length > 0 && babblesTodisplay[0] != 'empty'"
          >
            <div
            ...
            >
              ...
              <div class="media-content">
                <div class="content">
                  <div v-if="filterBy != 'songs'" class="tagBabblesWrapper">
                    <div
                  ...
                  <div v-if="filterBy == 'songs'">
                    <nuxt-link
                      ...
                      "
                    >
                      <h1 v-if="babble.title" class="babbleTitle">
                        <code v-html="babble.title"></code>
                      </h1>
                    </nuxt-link>
                    <div v-if="babble.mp3Link" class="lecteur-audio-songs">
                      <vue-plyr>
                        <audio>
              ...
              <nav class="media-right foOt">
                <div class="level-left sociaSh has-text-grey-light">
                  <div v-if="babble.babble && filterBy != 'songs'">
                    <ShareNetwork
                      network="facebook"
                      :url="
                  ...
                  <div
                    v-else-if="
                      babble.babble && filterBy == 'songs' && babble.title
                    "
                  >
                    <ShareNetwork
                      network="facebook"
                  ...
                  <div v-else-if="babble.mp3Link">
                    ...
                    <a
                      class="pointer"
                      v-clipboard:success="handleSuccess"
                      v-clipboard="'https://www.footfoot.co/mypage/podcast'"
                      type="button"
                    >
                      <i class="fa fas fa-copy"></i
                    ></a>
                ...
                <div class="add-team-and-like">
                  <nuxt-link
                    v-if="babble.babble && filterBy == 'songs' && babble.title"
                    :to="
                      filterBy === 'songs'
                        ? '/teams/' +
                          team.shortName +
                          ...
                          '/' +
                          babble._id
                        : '/teams/' + team.shortName + '/babble/' + babble._id
                    "
          ...
          >
            <div class="content-no-bet" v-if="filterBy === 'all'">
              {{
                langSelected === "EN"
                  ? " This team timeline is empty"
                  : " il n'y a pas encore de news sur cette équipe !"
              }}
              <br />
              <nuxt-link
                v-if="!mobile"
            ...
            <div v-if="filterBy === 'podcast'">
              {{
                langSelected === "EN"
                  ? " No podcast on this team yet"
                  : " il n'y a pas encore de podcast sur cette équipe !"
              }}
            </div>
            <div v-if="filterBy === 'buts'">
              {{
                langSelected === "EN"
                  ? " No GOAL on this team yet"
            ...
            <div v-if="filterBy === 'songs'">
              {{
                langSelected === "EN"
                  ? " No songs on this team yet"
                  : " il n'y a pas encore de chants sur cette équipe !"
              }}
            </div>
          </div>
        </div>
      ...
      <div v-else class>
        <div v-if="filterBy === 'forum'" class="publishWrapper box">
          <img
            v-if="connectedUser && connectedUser.initalPicture"
          ...
          <b-input
            class="publishText forumPublishText"
            :placeholder="`Question, débat, polémique sur ce club ?`"
            type="textarea"
            v-model="textForum"
          ></b-input>

          <div @click="sendAskForum" class="faWrapper">
        ...
        <div v-if="forums">
          <div v-if="forums[0] != 'empty'">
            ...
            >
              ...
              <h1 class="forumTitleH1">
                <figure v-if="forum && forum.team && forum.team.length > 0">
                  <img
                    loading="lazy"
                    class
                    ...
                    :class="{
                      invertOk:
                        forum && forum.team[0] && forum.team[0].teamName
                          ? forum.team[0].teamName
                              .toUpperCase()
                              .includes('JUVE')
                          : false,
                    }"
                ...
                <figure
                  v-else-if="forum && forum.tags && forum.tags.length > 0"
                >
                  <img
                    loading="lazy"
              ...
              <nav class="media-right foOt navForum">
                <div class="level-left sociaSh has-text-grey-light">
                  <div v-if="babble && babble.teamLink">
                    <ShareNetwork
                      network="facebook"
                      :url="
                        babble.teamLink.length > 0
          ...
          <div v-else class="box babble-container no-babble">
            <p>
              {{
                langSelected === "EN"
                  ? "There is no question on this team"
                  : "lance un débat"
              }}
            </p>
          </div>
...
<script>
import { postLike, postLikeFansong, askForum } from "@/server/api";
import { deleteABbbles, deleteAforum } from "@/server/api";
  ...
  watch: {
    filterBy: {
      ...
      handler(val, oldVal) {
        if (this.filterBy == "all") {
          ...
          this.babblesTodisplay = this.babblesSong;
    ...
    $route() {
      ...
      if (
        ...
        this.babbles &&
        this.babbles.length > 1
      ) {
        let favTeambabbletoCommit = {
          page: 1,
          babbles:
            this.babbles.length < 11 ? this.babbles : this.babbles.slice(0, 10),
        };
        this.$store.commit("datapage/favTeambabble", favTeambabbletoCommit);
      }
    },
  },
