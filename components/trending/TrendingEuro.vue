    ...
    >
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div>
            <div v-if="index2Selected === 'groupe' && groups.length > 0">
              <div v-for="(group, index) in groups" :key="index">
                <h1 class="groupe is-wc has-text-centered">
                  <strong class="is-wc has-text-centered">{{
                    group.name
                  }}</strong>
                </h1>
                <b-table
                  v-if="group.data && group.data.standings"
                    ...
                    >
                      <div class="journee">
                        ...
                        <div class="mobileOnly">
                          ...
                          <strong
                            v-if="props.row.info.venue"
                            class="has-text-yellow"
                            >{{ props.row.info.venue.data.name }}</strong
                          >
                        </div>
                      </div>
                    </b-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      isLoading: false,
      currentStage: "",
      stageArray: ["8th Finals", "Quarter-finals", "Semi-finals", "Final"],
      swiperOptions: {
        threshold: 15,
        followFinger: false,
        loop: true,
