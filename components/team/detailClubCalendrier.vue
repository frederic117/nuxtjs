    ...
    <div class="card matchlist">
      ...
      >
        <template slot-scope="props">
          <b-table-column class="NextMatchWrapper sideTab" centered>
            <div class="journee">
              ...
              <div class="mobileOnly">
                ...
                >
                <strong
                  v-if="props.row.time.status.toUpperCase() === 'POSTP'"
                  class="is-wc"
                  >{{
                ...
                >
                <strong
                  v-if="props.row.time.status.toUpperCase() === 'CANCL'"
                  class="is-wc"
                  >{{
                ...
                >
                <strong
                  v-if="props.row.time.status.toUpperCase() === 'DELAYED'"
                  class="is-wc"
                  >{{
                    langSelected === "EN"
          ...
          <b-table-column class="NextMatchWrapper desktopOnly sideTab" centered>
            <div class="journee">
              <div class>
                <strong
                  v-if="
    ...
    team: {
      ...
      handler(val, oldVal) {
        if (this.team && this.team.calendarAndResults) {
          this.calendrier = this.team.calendarAndResults.matchCalendarList.filter(
            (m) => {
              return m.time.status != "ABAN";
            }
          );
          this.loading = false;
        } else {
