<template>
  <div class="trendingWrapper">
    <div v-if="connectedUser && matchList">
      <b-loading
        :is-full-page="true"
        :active.sync="loading"
        :canCancel="false"
      ...
      <div v-if="matchList && matchList.length > 0 && loading === false">
        <div
                  ...
                  <div class="journee">
                    ...
                    >
                      <img
                        ...
                        :src="
                          '/logoLigue/' +
                          match.match.codeCompetitionApi +
                          '.png'
                        "
                        alt="logoLigue"
                      />
                    ...
                    <div class="bullsAndBearsPic">
                      ...
                      >
                        <img
                          ...
                          :class="{
                            invertOk: match.match.homeTeamId.name
                              .toUpperCase()
                              .includes('JUVE'),
                          }"
                        />
                    ...
                    <div class="bullsAndBearsPic">
                      ...
                      >
                        <img
                          ...
                          :class="{
                            invertOk: match.match.awayTeamId.name
                              .toUpperCase()
                              .includes('JUVE'),
                          }"
                        />
      ...
      <div v-if="matchList && matchList.length == 0 && loading === false">
        <p
          v-if="$auth.user && $auth.user._id != $route.params.id"
          class="content-no-bet"
        >
          {{
            langSelected === "EN"
        ...
        <p v-else class="content-no-bet">
          {{
            langSelected === "EN" ? "You have no bet" : "Tu n'as pas de prono"
          }}
          <br />
          <nuxt-link class="buttonContest" to="/contest">
            <button class="button is-contest">
    ...
    <div v-else-if="connectedUser && !matchList">
