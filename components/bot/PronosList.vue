<template>
  <section v-if="bigMatches && bigMatches.length > 0" class="main">
    <div class="pronolist box column is-6">
      <h1 class="has-text-contest headingTitle">
        <img
          ...
          alt="footfootLogo"
        />
        Qui va choper la chatte à DD ?
        <br />
        <h2>Défis tes amis sur les matchs à venir !</h2>
      </h1>
                  ...
                  <div class="bullsAndBearsPic">
                    ...
                    >
                      <img
                        loading="lazy"
                        :class="{
                          invertOk: match.homeTeamId.name
                            .toUpperCase()
                            .includes('JUVE'),
                        }"
...
import { getMatchsList } from "@/server/apiContest";
export default {
  data() {
    return {
      total: 0,
